...
<script type="text/javascript" defer="defer">
	function fn_save() {
		document.addForm.action = "/faq/edit";
	...
	function fn_detele() {
		document.addForm.action = "/faq/delete";
		document.addForm.submit();
	}
...
<body>
	...
	<div class="title">
		[Little Forest] FAQ 수정/삭제 페이지 <i class="bi bi-key"></i>
	</div>
	<div class="container">
		<!-- form 태그 시작 -->
		<form id="addForm" name="addForm" method="post" action="/faq/edit">
			...
			<button type="button" class="btn btn-outline-danger" onclick="fn_detele()">삭제</button>
		</form>
		<!-- form 태그 끝 -->
	</div>
