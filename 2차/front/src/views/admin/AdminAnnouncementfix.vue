            ...
            <div class="notice_container1">
                <div class="notice_content1">
                    ...
                    <div class="form-floating talk_content1">
                        <textarea type="text" class="form-control" id="titleTextarea" placeholder="제목" required
                            style="height: 60px" v-model="announcement.title"></textarea>
                        <label for="titleTextarea">제목</label>
                    </div>
                    <br />
                    <!-- 내용 수정 -->
                    <div class="form-floating talk_content1">
                        <textarea type="text" class="form-control" id="contentTextarea" placeholder="내용" required
                            style="height: 100px" v-model="announcement.content"></textarea>
    ...
    methods: {
        ...
        async getDetail(ano) {
            try {
                ...
                console.error(`Requesting: /api/admin/fix/${ano}`);
